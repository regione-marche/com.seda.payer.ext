...
public class Server {
	...
	private static final LoggerWrapper _logger =  CustomLoggerManager.get(Server.class);
	...
	/**
	 * Effettua i controlli di valid� dei dati ricevuti ed estrae l'xml del &lt;PaymentRequest&gt; dal &lt;Buffer&gt;
	...
	public String getPaymentRequest(String buffer, int window_minutes) throws SedaExtException
	{
		...
		String bufferDatiPaymentRequest = coreCS.decodeBuffer(buffer, window_minutes, _encryptIV, _encryptKey);
	...
	/**
	 * Effettua i controlli di valid� dei dati ricevuti ed estrae il Request ID dal &lt;Buffer&gt;
	 * @param buffer Stringa xml del &lt;Buffer&gt; ricevuto
	 * @param window_minutes Finestra tenporale entro la quale ritenere valido il messaggio ricevuto
	 * @return Request ID
	 * @throws SedaExtException
	...
	/**
	 * Effettua i controlli di valid� dei dati ricevuti ed estrae il Payment ID dal &lt;Buffer&gt;
	 * @param buffer Stringa xml del &lt;Buffer&gt; ricevuto
	 * @param window_minutes Finestra tenporale entro la quale ritenere valido il messaggio ricevuto
	 * @return Payment ID
	 * @throws SedaExtException
	 ...
	 * @param bufferDati Stringa xml del &lt;PaymentData&gt; che verr� codificato e innestato all'interno del tag &lt;BufferDati&gt; del buffer finale
