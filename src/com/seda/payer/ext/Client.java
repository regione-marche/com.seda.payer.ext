...
public class Client {
	...
	private static final LoggerWrapper _logger =  CustomLoggerManager.get(Client.class);
...
//		_logger = SedaExtLogger.getLogger("FILE");
	 ...
	 * @param bufferDati Stringa xml del &lt;PaymentRequest&gt; che verr� codificato e innestato all'interno del tag &lt;BufferDati&gt; del buffer finale
	...
	public String getBufferPaymentRequest(String bufferDati) throws SedaExtException
	{
		...
		return coreCS.creaBuffer(bufferDati, _encryptIV, _encryptKey, _codicePortale);
	}

	
	/**
	 * Costruisce l'xml del &lt;Buffer&gt; da utilizzare per il redirect al Server
	 * @param rID Request ID che verr� codificato e innestato all'interno del tag &lt;BufferDati&gt; del buffer finale
	 * @return Stringa xml del &lt;Buffer&gt; costruito
	 * @throws SedaExtException
	 */
	public String getBufferRID(String rID) throws SedaExtException
	{
		...
		return coreCS.creaBuffer(rID, _encryptIV, _encryptKey, _codicePortale);
	}
	
	/**
	 * Costruisce l'xml del &lt;Buffer&gt; da utilizzare per lo scambio S2S con il Server
	 * @param pID Payment ID che verr� codificato e innestato all'interno del tag &lt;BufferDati&gt; del buffer finale
	 * @return Stringa xml del &lt;Buffer&gt; costruito
	 * @throws SedaExtException
	 */
	public String getBufferPID(String pID) throws SedaExtException
	{
		...
		return coreCS.creaBuffer(pID, _encryptIV, _encryptKey, _codicePortale);
	}
	
	/**
	 * Effettua i controlli di valid� dei dati ricevuti ed estrae l'xml del &lt;PaymentData&gt; dal &lt;Buffer&gt;
	...
	public String getPaymentData(String buffer, int window_minutes) throws SedaExtException
	{
		...
		return coreCS.decodeBuffer(buffer, window_minutes, _encryptIV, _encryptKey);
	}
}
